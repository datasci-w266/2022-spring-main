...
* [Piazza](https://piazza.com/berkeley/spring2022/datasciw266) - we'll use this for Q&A, and this will be the fastest way to reach the course staff. Note that you can post anonymously, and/or make posts visible only to instructors for private questions.
...
* Course website: [GitHub datasci-w266/2022-spring-main](../../../)
* [Piazza](https://piazza.com/berkeley/spring2022/datasciw266) - we'll use this for Q&A, and this will be the fastest way to reach the course staff. Note that you can post anonymously, and/or make posts visible only to instructors for private questions.
...
* (Section 98) Tuesday 2 - 3:30p Pacific (Peter Grabowski)
* (Section 2) Tuesday 4 - 5:30p Pacific (Daniel Cer)
* (Section 4) Wednesday 4 - 5:30p Pacific (Mark Butler)
* (Section 99) Wednesday 4 - 5:30p Pacific (Natalie Ahn) 
* (Section 3) Wednesday 6:30 - 8p Pacific (Mike Tamir/Paul Spiegelhalter)
* (Section 5) Thursday 4 - 5:30p Pacific (Mark Butler) 
...
<tr><!--- Project Reports -->
  ...
  <td></td>
  <td></td>
  <td><br>due Apr&nbsp;9<br><strong>(hard deadline)</strong></td>
</tr>
...
<tr><!--- Introductions -->
  <td><strong>Week&nbsp;1</strong><br>(Jan&nbsp;3)</td>
  <td>Introduction
  </td>
  <td><ul>
...
<tr><!--- Week 2 -->
  <td><strong>Week&nbsp;2</strong><br>(Jan&nbsp;10)</td>
  <td>
...
<tr><!--- Sentiment/Classification -->
  <td><strong>Week&nbsp;3</strong><br>(Jan&nbsp;17)</td>
...
<tr><!--- Classification and Convolutional Networks-->
  <td><strong>Week&nbsp;4</strong><br>(Jan&nbsp;24)</td>
...
<tr><!--- Language models and n-grams -->
  <td><strong>Week&nbsp;5</strong><br>(Jan&nbsp;31)</td>
...
<tr><!--- Neural language models and RNNs -->
  <td><strong>Week&nbsp;6</strong><br>(Feb&nbsp;7)</td>
...
<tr><!--- Week 7  -->
  <td><strong>Week&nbsp;7</strong><br>(Feb&nbsp;14)</td>
  ...
  <td><strong>Week&nbsp;8</strong><br>(Feb&nbsp;21)</td>
  <td>No Async</td>
  <td><ul>
  <li>Self-Attention
  <li>Transformers
...
<tr><!--- Week 09 Entities -->
  <td><strong>Week&nbsp;9</strong><br>(Feb&nbsp;28)</td>
  <td>Entities</td>
  <td><ul>
...
<tr><!--- Week 10 Summarization-->
  <td><strong>Week&nbsp;10</strong><br>(Mar&nbsp;7)</td>
  <td>Summarization</td>
  <td><ul>
 ...
 <tr>
  <td><strong>Spring Break</strong><br>(Mar&nbsp;21)</td>
  <td>No Async</td>
    <td>No class</td>
  <td>No Readings</td>
</tr>
...
<tr><!--- POS Tagging and Parsing -->
  <td><strong>Week&nbsp;12</strong><br>(Mar&nbsp;28)</td>
...
<tr><!--- Week 13 Information Retrieval -->
  <td><strong>Week&nbsp;13</strong><br>(Apr&nbsp;4)</td>
 ...
 <tr><!--- In class presentations week 14 -->
  <td><strong>Week&nbsp;14</strong><br>(Apr&nbsp;11)</td>
    <td></td>
